...
export function WebSocketProvider({ children }: WebSocketProviderProps) {
  ...
  const enableWS = (import.meta as any).env?.VITE_ENABLE_WS !== 'false';

  useEffect(() => {
    if (!enableWS) {
      // WebSockets disabled by configuration (e.g., serverless env)
      if (socket) {
  ...
  }, [user?.id, enableWS]); // Re-evaluate when config changes
